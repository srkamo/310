                            ...
                            <form action="" method="">                        
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row p-b-15  ">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Rating title<small>(required)</small></label>
                                    ...
                                    <div class="tab-pane" id="step2">
                                        <h4 class="info-text"> Create Your Rating </h4>
                                        <div class="row">
                                            <div class="col-sm-12"> 
                                                <div class="col-sm-12"> 
                                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane" id="step3">                                        
                                        <h4 class="info-text">Upload an image for your rating. </h4>
                                        <div class="row">  
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="property-images">Choose Image:</label>
                                                    <input class="form-control" type="file" id="property-images">
                                                    <p class="help-block">Select an image for your rating.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
