...
<html class="no-js"> <!--<![endif]-->
    ...
    <%
    	...
    	ArrayList<Blog> allBlogs = km.getAllBlogs();
    %>
                ...
                <div class="row">
                    <div class="blog-lst col-md-12 pl0">
                        ...
                        for(int i=0; i < allBlogs.size(); i++){
                        	Blog currBlog = allBlogs.get(i); 
                        	title = currBlog.getTitle(); 
                        	description = currBlog.getDescription(); 
                        	creator = currBlog.getCreator(); 
                        	image = currBlog.getImage(); 
                        	id = currBlog.getID();
                        ...
                        %>
                        	<section class="post">
	                            ...
	                            <div class="image wow fadeInLeft animated">
	                                <a  href=<%="\" blogPage.jsp?subjectID=" + id + "\"" %>>
	                                    <img src="<%=image%>" class="img-responsive" alt="Example blog post alt">
	                                </a>
	                            </div>
	                            <p class="intro"><%=description%></p>
	                            <p class="read-more">
	                                <a  href=<%="\" blogPage.jsp?title=" + title + "\"" %> class="btn btn-default btn-border">Continue reading</a>
	                            </p>
	                        </section> 
	                    <%
                        }
