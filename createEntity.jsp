...
<html>
	...
	<body>
		...
		*/
		...
		//missing info
		if(title.equals("") || image.equals("") || description.equals("") || allTags.equals("")){
		...
		if(!errorFound){
			...
			Entity newEntity = new Entity(title, id, description, tags, isInfinite,  timeEnd, 
