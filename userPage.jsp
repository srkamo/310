	            		...
	            		for(int i=0; i < currUserActions.size(); i++){
		            		...
		            		if(currUserActions.get(i) instanceof CommentAction){
				        		if(km.getEntity(subjectID) == null){
				        			...
				        			%><center><p>You commented on a poll titled: <strong><%= title %></strong></p></center> <%
				        		} 
				        		else {
				        			title = km.getEntity(subjectID).getTitle(); 
				        			%><center><p>You commented on a rating titled: <strong><%= title %></strong></p></center> <%
				        		}
							}
				        	else if(currUserActions.get(i) instanceof PollAction){
				        		content = ((PollAction)currUserActions.get(i)).getOptionChosen();
				        		title = km.getPoll(subjectID).getTitle(); 
				        		%><center><p>You voted <strong><%= content %></strong> on a poll titled: <strong><%= title %></strong></p></center> <%
				        		...
				        		title = km.getEntity(subjectID).getTitle(); 
				        		if(isUpVote){
				        			%><center><p>You gave a thumbs up to a rating titled: <strong><%= title %></strong></p></center> <%
				        		}
				        			
				        		else{
				        			%><center><p>You gave a thumbs down to a rating titled: <strong><%= title %></strong></p></center> <%
				        		}
