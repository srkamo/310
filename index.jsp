                        ...
                        <div class="search-form wow pulse" data-wow-delay="0.8s">
                            <form action="servlets/searchButton.jsp" class=" form-inline">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Search for USC-related campus content and the opinions of your fellow Trojans" name="searchTextBar" id="searchTextBar">
                                </div>
                               ...
                               <a  href="servlets/searchButton.jsp?frequentSearch=pizza">  
                                <p> #Pizza </p>   
                                </a>    
            ...
            <div class="container">
		        ...
		        for(i=0; i < allItems.size(); i++){
		        	...
		        	%>
			        	...
			        	<div max-width="500px" max-height="500px" class="col-sm-6 col-md-3 p0">
