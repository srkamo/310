                        ...
                        <div class="wizard-card ct-wizard-orange" id="wizardProperty">
                                ...
                                <div class="wizard-header">
                                    <h3>
                                        ...
                                        <h4 class="info-text" style="color: red;"><%=errorMessageCreateEntity %></h4>
                                    </h3>
                                </div>
                                
                                <form action="servlets/createEntity.jsp" method="post" name="createEntityForm" >
                                ...
                                <div class="form-group">
                                    <label>Entity Tags (separated by commas) <small>(required)</small></label>
                                ...
                                <div class="form-group">
                                   <label>Would you like your entity to be anonymous? <small>(if so, check the box below)</small></label> 
                             	   <input name="anon-checkbox" type="checkBox" class="form-control"> <br>
                                </div>
