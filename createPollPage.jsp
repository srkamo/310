			...
			<div class="clearfix">
				<div class="wizard-container">
					...
					<div class="wizard-card ct-wizard-orange" id="wizardProperty">
							...
							<h4 class="info-text"><%=errorMessageCreatePoll %></h4>

							<form action="servlets/createPoll.jsp" method="post" >
                                ...
                                <div class="form-group">
                                	<label>Poll Option 3 <small>(optional)</small>
									</label> <input name="option3" type="text" class="form-control">
                                </div>
                                
                                <div class="form-group">
                                	<label>Poll Option 4 <small>(optional)</small></label> 
                                ...
                                <div class="form-group">
	                                <label>Poll End Time <small>(required)</small></label>
